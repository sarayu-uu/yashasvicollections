      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link href="/" className="text-[#f8f8f8] hover:text-white transition-colors duration-200 relative group">
              Home
            ...
            <div className="relative" ref={shopMenuRef}>
              ...
              {isShopMenuOpen && (
                <div className="absolute left-0 mt-2 w-48 bg-[#001144] rounded-md shadow-lg py-1 z-20">
                  <Link href="/sarees" className="block px-4 py-2 text-sm text-[#f8f8f8] hover:bg-[#001144]/80">Sarees</Link>
                  <Link href="/dresses" className="block px-4 py-2 text-sm text-[#f8f8f8] hover:bg-[#001144]/80">Dresses</Link>
                  <Link href="/jewellery" className="block px-4 py-2 text-sm text-[#f8f8f8] hover:bg-[#001144]/80">Jewellery</Link>
                </div>
              )}
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-[#001144] border-t border-[#f8f8f8]/20">
              <Link href="/" className="text-[#f8f8f8] hover:text-white block px-3 py-2 transition-colors duration-200 relative group">
                Home
              ...
              {isShopMenuOpen && (
                <div className="pl-6 pb-2 space-y-1">
                  <Link href="/sarees" className="block px-3 py-2 text-sm text-[#f8f8f8] hover:bg-[#001144]/80">Sarees</Link>
                  <Link href="/dresses" className="block px-3 py-2 text-sm text-[#f8f8f8] hover:bg-[#001144]/80">Dresses</Link>
